    ...
    <>
      ...
      <main className="second-page">
        <div className="about-us">
          <div ref={ref} className={`hidden about-us-container one-section ${visible}`}>
          ...
          <div ref={ref} className={`hidden about-us-container three-section ${visible}`}>  <h1 className="big-tittles">| Tittle |</h1>
